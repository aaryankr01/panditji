      ...
      <div className="p-6 bg-white border-b border-gray-200 shrink-0">
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            ...
            className="px-6 py-2 bg-orange-600 text-white font-bold rounded-lg hover:bg-orange-700 disabled:opacity-50 shadow-lg transition-all active:scale-95 text-sm"
          >
          ...
          <div className="space-y-3 p-4 bg-gray-50 rounded-xl border border-gray-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <input
                ...
                className="sm:col-span-1 p-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-orange-500 outline-none"
                value={panditFilters.search}
                onChange={(e) => setPanditFilters({ ...panditFilters, search: e.target.value })}
              />
              <select
                className="p-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-orange-500 outline-none bg-white"
          ...
          <div className="space-y-3 p-4 bg-gray-50 rounded-xl border border-gray-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <input
                type="text"
                placeholder="Search Name..."
                className="sm:col-span-1 p-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none"
