...
const pujas = [
  ...
  { id: 6, name: 'Mundan Ceremony', image: '/pictures/mundanceremony.jpg', rating: 4.5, conducted: 215, isPopular: false, desc: 'First haircut ritual for child.', longDesc: 'Mundan is a highly auspicious ceremony where a child receives their first haircut. It is believed to purify the child, free them from past life karma, and promote healthy mental and physical growth.', duration: '1-2 hrs', price: 'â‚¹2,100', category: 'Life Events' },
