...
const PUJA_PRICES = {
  'Rudrabhishek': 3100, 'Sunderkand Path': 3500, 'Griha Pravesh': 11, 'Vivah Ceremony': 11000,
...
const pujas = [
  ...
  { id: 6, name: 'Mundan Ceremony', image: '/pictures/mundanceremony.jpg', rating: 4.5, conducted: 215, isPopular: false, desc: 'First haircut ritual for child.', longDesc: 'Mundan is a highly auspicious ceremony where a child receives their first haircut. It is believed to purify the child, free them from past life karma, and promote healthy mental and physical growth.', duration: '1-2 hrs', price: '₹2,100', category: 'Life Events' },
  ...
  { id: 17, name: 'Annaprashan', image: '/pictures/annaprashann.jpg', rating: 4.4, conducted: 180, isPopular: false, desc: 'First solid food ritual for baby.', longDesc: 'Annaprashan marks the milestone of a baby consuming solid food for the first time. The puja invokes blessings for the child\'s health, digestion, and a life filled with abundance and nourishment.', duration: '1-2 hrs', price: '₹1,500', category: 'Life Events' },
